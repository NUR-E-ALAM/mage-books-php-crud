...
$insertQuery1 = "INSERT INTO writers (writer_name, writer_info, status) VALUES ('$name', '$info', '$status')";
...
header('Location:show_writer.php');
                          ...
                          <h2 class="card-title">Writer Add Form</h2>
                          <form class="forms-sample" method="post" enctype="multipart/form-data" >
                              <div class="form-group row">
                                  <label for="exampleInputEmail2" class="col-sm-4 col-form-label">Writer Name</label>
                                  <div class="col-sm-8">
                                    <input type="text" name="writer_name" class="form-control p-input" id="exampleInputEmail2" aria-describedby="emailHelp2" placeholder="Writer_name">
                                  </div>
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <textarea class="form-control p-input" id="exampleTextarea2" name="writer_info" placeholder="Writer Information" rows="9"></textarea>
                                  </div>
                              </div>
